...
class UserCrudController extends Controller
{
    ...
    public function store(UserStoreRequest $request){
        ...
        $data['image'] = $request->file('image') == null ? $data->image : $request->file('image')->store('users', 'images');
    ...
    public function update($id, UserUpdateRequest $request)
    {
        ...
        $data['image'] = $request->file('image') == null ? $user->image : $request->file('image')->store('users', 'images');
